                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            <Card class="bg-white rounded-lg shadow-sm">
                                <CardHeader class="border-b border-slate-100">
                                    ...
                                    <CardHeaderDescription>Follow these steps to begin customizing project_name.</CardHeaderDescription>
                                </CardHeader>
                            ...
                            <Card class="bg-white rounded-lg shadow-sm">
                                <CardHeader class="border-b border-slate-100">
                                    ...
                                    <CardHeaderDescription>Learn how SXO works with Basecoat.</CardHeaderDescription>
                                </CardHeader>
                                <CardSection class="space-y-3 text-slate-700">
                                    <ul class="space-y-2">
